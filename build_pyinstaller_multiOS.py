...
def main():
    ...
    if os_name == "darwin":
        ...
        dmg_cmd = [
            "create-dmg",
            "--volname", "NoClaw Installer",
            "--app-drop-link", "400", "120",
            "--window-size", "600", "400",
            "--icon-size", "100",
            "--icon", "NoClaw.app", "150", "120",
            str(dmg_path),
            str(dist_output)
        ]
        ...
        try:
            ...
            print("You can now distribute the DMG. Users can drag NoClaw to Applications.")
